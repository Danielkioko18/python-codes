...
loginEntry = LabelFrame(admin, text="Login", bg="Blue", bd=5,  padx=20, pady=50, font=("times", 18,"bold"), relief=RIDGE)
...
regButton=Button(admin, command=admin,text="ADMIN", bg="yellow", fg="red", activebackground="red", activeforeground="green", relief=RAISED, font=("Verdana", 16, "bold"))
